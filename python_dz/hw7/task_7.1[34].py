...
#     <function_name>("пара-ра-рам рам-пум-пупам па-ре-по-дам") -> (True, [{'а': 4}, {'а': 2, 'у': 2},
#     {'а': 2, 'е': 1, 'о': 1}])
...
def winnie_pooh(rhythm):
    return True if len(set([sum([1 for x in el.lower() if x in 'аяуюоеёэиы']) for el in rhythm.split(' ')])) == 1 else\
        False


print(winnie_pooh("пара-ра-рам рам-пам-папам па-ра-па-дам"))
print(winnie_pooh("пара-ра-рам рам-пум-пупам па-ре-по-дам"))
print(winnie_pooh("пара-ра-рам рам-пуум-пупам па-ре-по-дам"))
print(winnie_pooh("Трам-пара-папам-парам-па-пам-пам-па Пум-пурум-пу-пурум-трам-пам-па"))
print(winnie_pooh("Пам-парам-пурум Пум-пурум-карам"))
