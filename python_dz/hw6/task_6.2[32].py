...
def el_idx(lst, min_range, max_range):
    return [i for i, el in enumerate(lst) if min_range <= el <= max_range]


lst1 = [-5, 9, 0, 3, -1, -2, 1, 4, -2, 10, 2, 0, -9, 8, 10, -9, 0, -5, -5, 7]

print(el_idx(lst1, 2, 10))
print(el_idx(lst1, 2, 9))
print(el_idx(lst1, 0, 6))
